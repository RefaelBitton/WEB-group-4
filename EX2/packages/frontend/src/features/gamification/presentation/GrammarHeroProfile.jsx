  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 md:p-12 pb-24 md:pb-12 flex flex-col items-center transition-colors duration-300" dir="rtl">
      ...
      <div className="w-full max-w-4xl flex flex-col-reverse sm:flex-row justify-between items-center gap-6 mb-10">
        ...
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white">פרופיל גיבור הדקדוק</h1>
      </div>
      ...
      <div className="w-full max-w-4xl grid gap-8 grid-cols-1 md:grid-cols-2">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[2.5rem] p-8 shadow-sm flex flex-col items-center text-center justify-between col-span-1 transition-colors duration-300">
          ...
          <div>
            ...
            <h2 className="text-3xl font-extrabold text-slate-800 dark:text-slate-100 mt-1">{RANK_MAP[rank] || rank}</h2>
          </div>
          <div className="mt-6">
        ...
        {showDebugPanel && (
          <div className="bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-8 shadow-inner md:col-span-2 animate-fade-in transition-colors duration-300">
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="px-6 py-3 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-750 rounded-xl font-bold text-slate-700 dark:text-slate-200 shadow-sm transition-all hover:-translate-y-0.5 active:scale-95 disabled:opacity-50 cursor-pointer animate-fade-in"
              >
                משפט נכון (+10 נקודות)
              </button>
              <button

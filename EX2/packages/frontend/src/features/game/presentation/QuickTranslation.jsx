...
export function QuickTranslation({ questionData, onAnswerSubmit, onBack }) {
      ...
      <div className="grid gap-4 sm:grid-cols-2 mb-10">
        {questionData.options.map((opt) => (
          <button 
            ...
            className="rounded-2xl border-2 border-slate-200 bg-slate-50 px-6 py-5 text-center text-2xl font-bold hover:border-purple-400 hover:bg-purple-50 hover:text-purple-700 transition-all cursor-pointer"
          >
            {opt.text}
          </button>
        ))}
